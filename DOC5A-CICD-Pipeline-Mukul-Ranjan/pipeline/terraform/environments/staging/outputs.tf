...
output "vpc_id" {
  description = "VPC ID for the NovaPay staging environment."
  value       = module.networking.vpc_id
}

output "private_subnet_ids" {
  description = "Private subnet IDs used by the staging EKS cluster."
...
output "eks_cluster_endpoint" {
  description = "Staging EKS Kubernetes API endpoint."
  value       = module.kubernetes_cluster.cluster_endpoint
}

output "eks_cluster_version" {
  description = "Kubernetes version of the staging EKS control plane."
...
output "application_log_group_name" {
  description = "CloudWatch application log group for staging."
  value       = module.monitoring.application_log_group_name
}

output "audit_log_group_name" {
  description = "CloudWatch audit log group for staging."
  value       = module.monitoring.audit_log_group_name
}

output "alerts_topic_arn" {
  description = "SNS topic used for staging monitoring alerts."
