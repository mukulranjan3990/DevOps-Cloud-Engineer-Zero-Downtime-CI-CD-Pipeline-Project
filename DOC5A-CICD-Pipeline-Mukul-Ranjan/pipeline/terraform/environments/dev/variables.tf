variable "aws_region" {
  description = "AWS region for the NovaPay development environment."
  type        = string
}

variable "name_prefix" {
  description = "Resource name prefix for the NovaPay development environment."
  type        = string
  default     = "novapay-dev"
...
variable "cluster_name" {
  description = "EKS cluster name for the NovaPay development environment."
  type        = string
  default     = "novapay-dev-eks"
...
variable "node_group_name" {
  description = "Managed EKS node group name for development."
  type        = string
  default     = "dev-system"
}

variable "node_instance_types" {
  description = "EC2 instance types for development EKS nodes."
  type        = list(string)
  default     = ["t3.large"]
...
variable "node_disk_size" {
  description = "Root EBS volume size in GiB for development worker nodes."
  type        = number
  default     = 40
...
variable "application_log_retention_days" {
  description = "CloudWatch application-log retention for development."
  type        = number
  default     = 30
...
variable "audit_log_retention_days" {
  description = "CloudWatch audit-log retention for development."
  type        = number
  default     = 90
...
variable "alert_email" {
  description = "Optional SNS email endpoint for development alerts. The recipient must confirm the subscription."
  type        = string
  default     = null
...
variable "tags" {
  description = "Additional tags for the development environment."
  type        = map(string)
  default     = {}
}
